  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <a
        ...
        className="fixed bottom-6 left-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all hover:bg-[#128C7E] hover:shadow-xl active:scale-95"
